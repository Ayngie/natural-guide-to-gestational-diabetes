...
const TrainingAdvice = () => {
  ...
  return (
    <section>
      ...
      <StyledHeadingMobile>
        Träningstips för bättre blodsocker
      </StyledHeadingMobile>
      <StyledGrid>
        <StyledAside>
          <nav>
        ...
        <StyledSplitSection className="articles-section">
          ...
          <StyledArticle id="links">
            ...
            <ParagraphWrapper>
              ...
              <Paragraph>
                <TextLink
                  href="https://diabetes.nu/diabetes-och-styrketraning/"
                  target="_blank">
                  {' '}
                  Diabetes.nu om styrketräning
                </TextLink>
                .
              </Paragraph>
              <Paragraph>
                <TextLink
                  href="https://www.diabetes.se/diabetes/diabetes-typ-2/traning/"
                  target="_blank">
                  {' '}
                  Svenska Diabetesförbundet om träning
                </TextLink>
                .
              </Paragraph>
              <Paragraph>
                <TextLink
                  href="https://www.fyss.se/wp-content/uploads/2018/01/Diabetes-TYP-2.pdf"
                  target="_blank">
                  {' '}
                  Fysisk aktivitet vid diabetes mellitus typ II
                </TextLink>
                (PDF).
              </Paragraph>
            </ParagraphWrapper>
            <ParagraphWrapper>
              ...
              <Paragraph>
                <TextLink
                  href="https://lakartidningen.se/klinik-och-vetenskap-1/artiklar-1/temaartikel/2022/09/fysisk-aktivitet-kan-ha-omedelbar-effekt-pa-depression-och-angest/"
                  target="_blank">
                  {' '}
